...
function PublicTextPage({ title, children, navigate, editorial = false }: { title: string; children: ReactNode; navigate: (page: Page) => void; editorial?: boolean }) {
  return <main className={(editorial ? "max-w-[1280px]" : "max-w-[900px]") + " mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16"}><button onClick={() => navigate("home")} className="h-9 px-4 rounded-full border border-zinc-200 text-[13px] font-medium inline-flex items-center gap-1.5 hover:bg-zinc-50 mb-8"><ArrowLeft className="w-4 h-4" /> Back Home</button><div className={editorial ? "max-w-[780px]" : "max-w-[800px]"}><div className="inline-flex px-3 py-1 rounded-full bg-[#FFF0F2] text-[#FF1A3D] text-[11px] font-semibold uppercase tracking-wide">Rupantar Homes</div><h1 className="font-heading text-[32px] sm:text-[44px] font-bold leading-[1.05] mt-4 tracking-[-0.02em]">{title}</h1><div className="mt-7 space-y-10 text-[15px] leading-7 text-zinc-600">{children}</div></div></main>;
}
...
export function PrivacyPage({ navigate }: { navigate: (page: Page) => void }) {
  return <PublicTextPage title="Privacy Policy" navigate={navigate}><p>Rupantar Homes respects the privacy of visitors and clients who use this website.</p><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Information We Collect</h2><p className="mt-3">When you use our forms or contact us through the website, we may collect information you choose to provide, including:</p><ul className="mt-4 list-disc pl-5 space-y-2"><li>your name</li><li>phone number</li><li>location</li><li>project category</li><li>approximate project size</li><li>material preferences</li><li>project requirements or message</li><li>photos you upload for an estimate</li></ul><p className="mt-4">We only collect information that is necessary to respond to inquiries, understand project requirements, prepare estimates, or communicate about our services.</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">How We Use Your Information</h2><p className="mt-3">Information submitted through the website may be used to:</p><ul className="mt-4 list-disc pl-5 space-y-2"><li>respond to your inquiry</li><li>contact you regarding your project</li><li>review uploaded space photos</li><li>understand project requirements</li><li>prepare an initial estimate</li><li>arrange further discussion or a site visit</li><li>maintain records related to inquiries and projects</li></ul><p className="mt-4">We do not sell your personal information.</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Uploaded Photos</h2><p className="mt-3">Photos uploaded through the Estimate form are provided for the purpose of understanding the space and project requirements.</p><p className="mt-4">Please upload only photos that you have permission to share.</p><p className="mt-4">Uploaded images may be stored and processed through the website's hosting, image-storage, and database services as necessary for the inquiry process.</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Third-Party Services</h2><p className="mt-3">The website may use third-party infrastructure and service providers for functions such as website hosting, form processing, database storage, image storage, and notifications.</p><p className="mt-4">These providers may process information only as necessary to provide those technical services.</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Data Security</h2><p className="mt-3">Reasonable technical measures are used to protect information submitted through the website. However, no internet-based system can guarantee absolute security.</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Data Retention</h2><p className="mt-3">Information may be retained for as long as reasonably necessary to respond to inquiries, manage project communication, maintain business records, or meet applicable legal obligations.</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Your Information</h2><p className="mt-3">If you want to ask about information you previously submitted through this website, you can contact Rupantar Homes directly.</p><p className="mt-3 whitespace-pre-line">Contact:{"\n"}Gokul Kunwar{"\n"}9745941799</p></section><section><h2 className="font-heading text-[24px] sm:text-[26px] font-bold leading-tight text-zinc-900">Changes to This Policy</h2><p className="mt-3">This Privacy Policy may be updated from time to time to reflect changes in the website, services, or business practices.</p></section><section className="pt-4"><h2 className="font-heading text-[28px] sm:text-[32px] font-bold leading-tight text-zinc-900">Terms &amp; Conditions</h2><div className="mt-3 space-y-3"><p>By using the Rupantar Homes website, you agree to the following basic terms.</p><p>Information on this website is provided for general information about Rupantar Homes and its services.</p><p>Any estimate provided before final measurements, site inspection, material selection, design approval, or scope confirmation may change.</p><p>Final project pricing, materials, specifications, payment terms, timeline, warranty terms, and responsibilities are confirmed separately between Rupantar Homes and the client before or during the project process.</p><p>Submitting an inquiry or Estimate form does not by itself create a construction, interior-design, or service contract.</p><p>Users are responsible for ensuring that information and images they submit are accurate and that they have permission to share any uploaded content.</p><p>Website content, project information, availability, services, and pricing may be updated when necessary.</p><p className="whitespace-pre-line">For questions regarding these terms, contact:{"\n"}Gokul Kunwar{"\n"}9745941799</p></div></section></PublicTextPage>;
}
