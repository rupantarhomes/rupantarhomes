...
function PublicTextPage({ title, children, navigate }: { title: string; children: ReactNode; navigate: (page: Page) => void }) {
  return <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16"><button onClick={() => navigate("home")} className="h-9 px-4 rounded-full border border-zinc-200 text-[13px] font-medium inline-flex items-center gap-1.5 hover:bg-zinc-50 mb-8"><ArrowLeft className="w-4 h-4" /> Back Home</button><div className="max-w-[780px]"><div className="inline-flex px-3 py-1 rounded-full bg-[#FFF0F2] text-[#FF1A3D] text-[11px] font-semibold uppercase tracking-wide">Rupantar Homes</div><h1 className="font-heading text-[38px] sm:text-[52px] font-bold leading-[1.03] mt-4 tracking-[-0.035em]">{title}</h1><div className="mt-8 space-y-12 sm:space-y-14 text-[15px] leading-7 text-zinc-600">{children}</div></div></main>;
}
  ...
  return (
    <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      ...
      <div className="max-w-[780px]">
        ...
        <h1 className="font-heading text-[38px] sm:text-[52px] font-bold leading-[1.03] mt-4 tracking-[-0.035em]">Contact Rupantar Homes</h1>
        <div className="mt-4 space-y-4 text-[15px] leading-7 text-zinc-600">
        ...
        <section className="mt-14 text-[15px] leading-7 text-zinc-600">
          <h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Contact Gokul Kunwar</h2>
        ...
        <section className="mt-14 sm:mt-16">
          <h2 className="font-heading text-[30px] sm:text-[34px] font-bold leading-tight tracking-[-0.02em] text-zinc-900">Frequently Asked Questions</h2>
          <div className="mt-9 space-y-10 sm:space-y-11 text-[15px] leading-7 text-zinc-600">
            <div><h3 className="font-heading text-[20px] sm:text-[22px] font-semibold leading-[1.2] text-zinc-900">What services does Rupantar Homes provide?</h3><p className="mt-3">Rupantar Homes provides Interior Design, Home Construction, 3D Design, Modular Kitchens, wardrobes, hydraulic beds, TV cabinets, false ceilings, partitions, custom furniture, and complete interior works.</p></div>
            <div><h3 className="font-heading text-[20px] sm:text-[22px] font-semibold leading-[1.2] text-zinc-900">Do you handle both interior design and home construction?</h3><p className="mt-3">Yes. Rupantar Homes works on both interior projects and complete home construction, depending on the project scope and requirements.</p></div>
            <div><h3 className="font-heading text-[20px] sm:text-[22px] font-semibold leading-[1.2] text-zinc-900">How can I get an estimate for my project?</h3><p className="mt-3">You can use the Estimate form on the website or contact Gokul Kunwar directly. Sharing your location, approximate measurements, requirements, and a clear photo of the space helps us understand the project better.</p></div>
            <div><h3 className="font-heading text-[20px] sm:text-[22px] font-semibold leading-[1.2] text-zinc-900">Can I send photos of my space before a site visit?</h3><p className="mt-3">Yes. You can upload a photo through the Estimate form or send project details directly. A site visit may still be required before final measurements, pricing, or execution.</p></div>
            <div><h3 className="font-heading text-[20px] sm:text-[22px] font-semibold leading-[1.2] text-zinc-900">Do you provide a design preview before work starts?</h3><p className="mt-3">Design previews can be provided as part of the project process where applicable. The exact design scope is confirmed based on the project requirements.</p></div>
            <div><h3 className="font-heading text-[20px] sm:text-[22px] font-semibold leading-[1.2] text-zinc-900">How do I contact Rupantar Homes directly?</h3><p className="mt-3">You can contact Gokul Kunwar at 9745941799 for project discussions, estimates, site visits, and general inquiries.</p></div>
          </div>
        </section>
      </div>
    </main>
...
export function PrivacyPage({ navigate }: { navigate: (page: Page) => void }) {
  return <PublicTextPage title="Privacy Policy" navigate={navigate}><p>Rupantar Homes respects the privacy of visitors and clients who use this website.</p><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Information We Collect</h2><p className="mt-3">When you use our forms or contact us through the website, we may collect information you choose to provide, including:</p><ul className="mt-4 list-disc pl-5 space-y-2"><li>your name</li><li>phone number</li><li>location</li><li>project category</li><li>approximate project size</li><li>material preferences</li><li>project requirements or message</li><li>photos you upload for an estimate</li></ul><p className="mt-4">We only collect information that is necessary to respond to inquiries, understand project requirements, prepare estimates, or communicate about our services.</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">How We Use Your Information</h2><p className="mt-3">Information submitted through the website may be used to:</p><ul className="mt-4 list-disc pl-5 space-y-2"><li>respond to your inquiry</li><li>contact you regarding your project</li><li>review uploaded space photos</li><li>understand project requirements</li><li>prepare an initial estimate</li><li>arrange further discussion or a site visit</li><li>maintain records related to inquiries and projects</li></ul><p className="mt-4">We do not sell your personal information.</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Uploaded Photos</h2><p className="mt-3">Photos uploaded through the Estimate form are provided for the purpose of understanding the space and project requirements.</p><p className="mt-4">Please upload only photos that you have permission to share.</p><p className="mt-4">Uploaded images may be stored and processed through the website's hosting, image-storage, and database services as necessary for the inquiry process.</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Third-Party Services</h2><p className="mt-3">The website may use third-party infrastructure and service providers for functions such as website hosting, form processing, database storage, image storage, and notifications.</p><p className="mt-4">These providers may process information only as necessary to provide those technical services.</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Data Security</h2><p className="mt-3">Reasonable technical measures are used to protect information submitted through the website. However, no internet-based system can guarantee absolute security.</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Data Retention</h2><p className="mt-3">Information may be retained for as long as reasonably necessary to respond to inquiries, manage project communication, maintain business records, or meet applicable legal obligations.</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Your Information</h2><p className="mt-3">If you want to ask about information you previously submitted through this website, you can contact Rupantar Homes directly.</p><p className="mt-3 whitespace-pre-line">Contact:{"\n"}Gokul Kunwar{"\n"}9745941799</p></section><section><h2 className="font-heading text-[24px] sm:text-[28px] font-bold leading-tight text-zinc-900">Changes to This Policy</h2><p className="mt-3">This Privacy Policy may be updated from time to time to reflect changes in the website, services, or business practices.</p></section><section className="pt-2 sm:pt-4"><h2 className="font-heading text-[32px] sm:text-[36px] font-bold leading-tight tracking-[-0.02em] text-zinc-900">Terms &amp; Conditions</h2><div className="mt-4 space-y-4"><p>By using the Rupantar Homes website, you agree to the following basic terms.</p><p>Information on this website is provided for general information about Rupantar Homes and its services.</p><p>Any estimate provided before final measurements, site inspection, material selection, design approval, or scope confirmation may change.</p><p>Final project pricing, materials, specifications, payment terms, timeline, warranty terms, and responsibilities are confirmed separately between Rupantar Homes and the client before or during the project process.</p><p>Submitting an inquiry or Estimate form does not by itself create a construction, interior-design, or service contract.</p><p>Users are responsible for ensuring that information and images they submit are accurate and that they have permission to share any uploaded content.</p><p>Website content, project information, availability, services, and pricing may be updated when necessary.</p><p className="whitespace-pre-line">For questions regarding these terms, contact:{"\n"}Gokul Kunwar{"\n"}9745941799</p></div></section></PublicTextPage>;
}
