  ...
  return (
    <main className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 pt-[4.75rem] pb-14 sm:py-16">
      <article className="rh-blog-article max-w-[800px]">
        ...
        {linkedWork && (
          <aside className="rh-blog-project-images mt-12 w-full rounded-[1.75rem] border border-zinc-100 bg-[#fffdfa] p-6 sm:p-7 shadow-[0_10px_30px_rgba(0,0,0,0.04)]" aria-label="Linked project images">
