...
-- Forward-only correction after reverting PR #90: restore the canonical Work
-- image maximum to three while preserving the already-applied migration history
-- and all existing authorization, categories, cleanup locking and persistence.
